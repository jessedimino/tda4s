...
class PersistentHomologySpec extends AnyFlatSpec:
  "The tetrahedron" should "have barcode" in {
    ...
    val filtrationValues = Map(
      Set(0) -> 0.0, Set(1) -> 1.0, Set(2) -> 2.0, Set(3) -> 3.0,
      Set(0, 1) -> 4.0, Set(0, 2) -> 5.0, Set(0, 3) -> 6.0, Set(1, 2) -> 7.0,
      Set(1, 3) -> 8.0, Set(2, 3) -> 9.0,
      Set(0, 1, 2) -> 10.0, Set(0, 1, 3) -> 11.0, Set(0, 2, 3) -> 12.0, Set(1, 2, 3) -> 13.0
    )
